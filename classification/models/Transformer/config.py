...
class Config:
    def __init__(self, hugging=None, model_name=None, model_path=None,
                 max_seq_length=512, num_classes=13, model_args={}, run=None,
                 ...
                 input_path='./data/', input_name='data.csv', separator=',', compression=None, class_names={}):
